...
module.exports = (stringOrXMLDoc) => {
  ...
  const userid = xpathSelect('string(/app:service/app:workspace/app:collection/snx:userid/text())', xmlDoc, true);
  ...
  _.map(xpathSelect('/app:service/app:workspace/atom:link[@rel]', xmlDoc), (xmlNode) => {
