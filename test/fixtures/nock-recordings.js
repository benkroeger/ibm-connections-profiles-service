...
nock('https://apps.na.collabserv.com:443', {"encodedQueryParams":true})
  .get('/profiles/atom/connections.do')
  .query({"connectionType":"colleague","outputType":"connection","page":"1","userid":"wrong user id","output":"vcard","format":"lite","sortBy":"displayName","sortOrder":"asc"})
...
nock('https://apps.na.collabserv.com:443', {"encodedQueryParams":true})
  ...
  .reply(200, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>", [ 'Content-Language',
  'en-US',
  'Content-Type',
  'application/atom+xml;charset=UTF-8',
  'Last-Modified',
