...
const authTypeInjectorPlugins = require('oniyi-http-plugin-auth-type-injector');
...
function IbmConnectionsProfilesService(baseUrl, options) {
  ...
  if (plugins.typeToNameMap) {
    httpClient.use(authTypeInjectorPlugins({ typeToNameMap: plugins.typeToNameMap }));
  }
